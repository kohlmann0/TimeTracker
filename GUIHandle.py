...
class GUIHandle(wx.Frame):
    ...
    def initialize(self):
        ...
        # Typical Process is Create Object, then Add the object to the layout manager (sizer in this case), then bind it to event handler
        ...
        # Add Text Box for Project Number
        # self.projectEntry = wx.TextCtrl(self, -1, value=u"Project Number")
